...
... | ⟨ l ℓ ⟪ c̅₁ ⟫ , v-cast i , M↠V , ⊑-cast ⊑-l c̅₁⊑c̅′ ⟩ =
  ...
  ⟨ c̅ₙ , up 𝓋 , c̅₁⨟c̅↠c̅ₙ , c̅ₙ⊑c̅′ ⟩ →
    ...
    l⊑l →
      ...
      ⟨ l ℓ ⟪ c̅ₙ ⟫ , v-cast ⟨ up 𝓋 , x ⟩ , ♥ ,
        ⊑-cast {g₁⊑g₁′ = l⊑l} {g₂⊑g′} ⊑-l c̅ₙ⊑c̅′ ⟩
... | ⟨ l ℓ ⟪ c̅₁ ⟫ , v-cast i , M↠V , ⊑-castl {g₁⊑g′ = g₁⊑g′} (⊑-castr ⊑-l ℓ⊑c̅′) c̅₁⊑g′ ⟩ =
  ...
  ⟨ c̅ₙ , inj 𝓋 , c̅₁⨟c̅↠c̅ₙ , c̅ₙ⊑c̅′ ⟩ →
    let ♥ = ↠ₑ-trans (plug-congₑ M↠V)
            (l ℓ ⟪ c̅₁ ⟫ ⟪ c̅ ⟫ —→⟨ comp i ⟩
             ...
             l ℓ ⟪ c̅ₙ ⟫ ∎) in
    ⟨ l ℓ ⟪ c̅ₙ ⟫ , v-cast ⟨ inj 𝓋 , (λ ()) ⟩ , ♥ ,
      ⊑-castl {g₁⊑g′ = g₁⊑g′} {⋆⊑} (⊑-castr {g⊑g₁′ = l⊑l} {g₁⊑g′} ⊑-l ℓ⊑c̅′) (⊑-left-contract c̅ₙ⊑c̅′) ⟩
  ⟨ c̅ₙ , up 𝓋 , c̅₁⨟c̅↠c̅ₙ , c̅ₙ⊑c̅′ ⟩ →
    case g₂⊑g′ of λ where
    l⊑l →
      let ♥ = ↠ₑ-trans (plug-congₑ M↠V)
              ...
              l ℓ ⟪ c̅ₙ ⟫ ∎) in
      ⟨ l ℓ ⟪ c̅ₙ ⟫ , v-cast ⟨ up 𝓋 , x ⟩ , ♥ ,
        ⊑-castl {g₁⊑g′ = g₁⊑g′} {l⊑l} (⊑-castr {g⊑g₁′ = l⊑l} {g₁⊑g′} ⊑-l ℓ⊑c̅′) (⊑-left-contract c̅ₙ⊑c̅′) ⟩
  ...
  ⟨ c̅ₙ , up 𝓋 , c̅₁⨟c̅↠c̅ₙ , c̅ₙ⊑c̅′ ⟩ →
    ...
    l⊑l →
      let ♥ = ↠ₑ-trans (plug-congₑ M↠V)
              ...
              l ℓ ⟪ c̅ₙ ⟫ ∎) in
      ⟨ l ℓ ⟪ c̅ₙ ⟫ , v-cast ⟨ up 𝓋 , x ⟩ , ♥ ,
        ⊑-cast {g₁⊑g₁′ = l⊑l} {l⊑l} ⊑-l c̅ₙ⊑c̅′ ⟩
catchup (v-cast ⟨ 𝓋′ , x ⟩) (⊑-castr {g} {g₁′} {g₂′} {M} {M′} {c̅′} {g⊑g₁′} {g⊑g₂′} M⊑V′ g⊑c̅)
  with catchup {g⊑g′ = g⊑g₁′} v-l M⊑V′
... | ⟨ l ℓ , v-l , M↠V , ⊑-l ⟩ =
  ⟨ l ℓ , v-l , M↠V , ⊑-castr {g⊑g₁′ = g⊑g₁′} {g⊑g₂′} ⊑-l g⊑c̅ ⟩
... | ⟨ l ℓ ⟪ c̅₁ ⟫ , v-cast i , M↠V , ⊑-castl ⊑-l c̅₁⊑ℓ ⟩ =
  ⟨ l ℓ ⟪ c̅₁ ⟫ , v-cast i , M↠V ,
    ⊑-castr {g⊑g₁′ = g⊑g₁′} {g⊑g₂′} (⊑-castl {g₁⊑g′ = l⊑l} {g⊑g₁′} ⊑-l c̅₁⊑ℓ) g⊑c̅ ⟩
