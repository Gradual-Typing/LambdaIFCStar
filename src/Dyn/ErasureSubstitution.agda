...
rename-erase ρ (ƛ N of low)
  rewrite rename-erase (ext ρ) N = refl
rename-erase ρ (ƛ N of high) = refl
{- -- -}
rename-erase ρ (M · N)
  rewrite rename-erase ρ M | rename-erase ρ N = refl
rename-erase ρ (if L M N)
