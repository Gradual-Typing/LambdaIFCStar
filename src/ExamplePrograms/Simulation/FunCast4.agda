module ExamplePrograms.Simulation.FunCast4 where
...
{- more precise -}
M′ =
  `let ƛ⟦ low ⟧ ` Bool of l high ˙ ` 0 of low `in
  `let (` 0) ∶ ⟦ ⋆ ⟧ (` Bool of l low) ⇒ (` Bool of l high) of ⋆ at pos 0 `in
  (((` 0) ∶ ⟦ ⋆ ⟧ (` Bool of l low) ⇒ (` Bool of l high) of l high at pos 2) · $ false of low at pos 1)
