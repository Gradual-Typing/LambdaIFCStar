...
stamp-cast-prec {ℓ} id id c~ c~′ (⊑-id l⊑l) g⊑g′ h≼h = {!!}
stamp-cast-prec id (inj v′) c~ c~′ prec g⊑g′ h≼h = {!!}
stamp-cast-prec id (up v′) c~ c~′ prec g⊑g′ h≼h = {!!}
stamp-cast-prec (inj v) v′ c~ c~′ prec g⊑g′ h≼h = {!!}
